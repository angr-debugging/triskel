...
TEST(SubGraph, Smoke) {
    ...
    ASSERT_TRUE(contains(g.nodes(), g.get_node(*n1)));
}
...
TEST(SubGraph, AddEdge) {
    ...
    ASSERT_TRUE(contains(g.edges(), g.get_edge(*e1_2)));
}
...
TEST(SubGraph, rmNode) {
    ...
    ASSERT_EQ(g.node_count(), og_size);
    ASSERT_TRUE(contains(g.edges(), g.get_edge(*e2_3)));
...
TEST(SubGraph, addEdge) {
    ...
    ASSERT_TRUE(contains(g.get_node(*n1)->edges(), new_edge));
    ASSERT_TRUE(contains(g.get_node(*n5)->edges(), new_edge));

    ASSERT_EQ(g.edge_count(), og_size + 1);
    ASSERT_EQ(g.edge_count(), g.edges().size());
...
TEST(SubGraph, rmEdge) {
    ...
    ASSERT_FALSE(contains(g.get_node(*n3)->edges(), e3_4));
    ASSERT_FALSE(contains(g.get_node(*n4)->edges(), e3_4));
    ...
    ASSERT_TRUE(contains(g.edges(), g.get_edge(*e3_4)));
    ASSERT_TRUE(contains(g.get_node(*n3)->edges(), g.get_edge(*e3_4)));
    ASSERT_TRUE(contains(g.get_node(*n4)->edges(), g.get_edge(*e3_4)));
}
